...
//===================master  user detail=========================suresh
    ...
    public void create_a_new_user_somethingsomethingsomethingsomethingsomething_and_something
            (String name, String mobilenumber, String emailid, String password, String userType, String branch) {
    ...
    public void admin_should_navigate_to_user_detail_page() {
        String text=masterPageObjectUser.pageText();
        Assert.assertEquals(text,"USER DETAILS");
    }
    @Then("^admin should see the record with Name \"([^\"]*)\"$")
    public void admin_should_see_the_record_with_name_something(String strArg1) {
    ...
    public void admin_click_on_group_test() {
        masterPageObject.validateGroupTest();
    }
    @Then("^admin should be on GROUP TEST NAMES page$")
    public void admin_should_be_on_group_test_names_page() {
    ...
    public void admin_search_group_test_name_from_the_table_something(String name) {
        masterPageObject.validateSearchBox(name);
    }
    @Then("^admin should found the group test name \"([^\"]*)\" from table$")
    public void admin_should_found_the_group_test_name_something_from_table(String testName) {
    ...
    public void admin_should_able_to_change_status_of_the_group_test_name() {
    ...
    public void admin_navigate_to_assign_group_test() {
    ...
    public void admin_should_shold_be_on_assign_grouptest_list_page() {
        boolean text=masterPageObject_AGT.verifyPageText();
        Assert.assertTrue(text);
    }
    @And("^admin create assign group test and add to list$")
    public void admin_create_assign_group_test_and_add_to_list() {
    ...
    public void admin_navigate_to_sub_test_link() {
    ...
    public void admin_click_on_add_new_button_to_add_sub_test() {
    ...
    public void admin_should_click_on_submit_button() {
        masterPageObject_subTest.validateSubmiteBtn();
    }
    @Then("^admin should return to SUB TEST PRICE LIST page$")
    public void admin_should_retuen_to_sub_test_price_list_page() {
    ...
    public void admin_should_see_the_error_massage() {
    ...
    public void user_should_be_on_new_user_register_page() {
    ...
    public void user_verify_the_something_button_by_click(String status) {
        registerPageObject.select_Status(status);
    }
    @And("^user select gender \"([^\"]*)\"$")
    public void user_select_gender_something(String gender) {
    ...
    public void user_select_branch_something(String branch) {
        registerPageObject.appointmentBranch(branch);
    }
    @And("^user select Test HAEMATOLOGY$")
    public void user_select_test_haematology() {
    ...
    public void user_should_navigate_to_appointment_page() {
    ...
    @When("^user click on \"([^\"]*)\"$")
    public void user_click_on_something(String Appointment_page) {
    ...
    public void user_select_date_range_something_to_something(String fromDate, String toDate) {
         appointmentsPageObject.enterDateRange(fromDate,toDate);
    }
    @And("^user select number of entry per page All$")
    public void user_select_number_of_entry_per_page_All() {
        appointmentsPageObject.validateEntryFunction();
    }
    @Then("^user verify the appointment record by name \"([^\"]*)\"$")
    public void user_verify_the_appointment_record_by_name_something(String name) {
    ...
    public void user_search_something_and_click_on_plus_button_to_see_the_patient_details(String name) {
     appointmentsPageObject.searchEntry(name);
    }
    @And("^user cancel appointment by name \"([^\"]*)\"$")
    public void user_cancel_appointment_by_name_something(String name) {
           appointmentsPageObject.verifyCancelAction(name);
    }
    @Then("^user should navigate to APPOINTMENTS DETAILS page$")
    public void user_should_navigate_to_appointments_details_page() {
